<?php
session_start();
$_SESSION['pageActuelle']="inscriptionClient.php";
?>
        ...
        <div class="containerlogin">
            <div class="signup-content">
                <div class="signup-form">
                    <h2 class="form-title">Inscription client</h2>
                    <form method="POST" class="register-form" id="register-form" action="#">
                        <div class="form-group">
                            <label for="username"><i class="zmdi zmdi-account material-icons-name"></i></label>
                            <input type="text" name="username" id="username" placeholder="Votre identifiant de connexion" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group form-button">
                            <input type="submit" name="signup" id="signup" class="form-submit" value="S'inscrire" onclick="checkInscriptionClient()"/>
                        </div>
                    </form>
                </div>
            </div>
